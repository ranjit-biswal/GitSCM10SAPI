...
public class OneTimePaymentAPI {
	...
	public static HashMap<String, String> getPaymentFrom_ChaseDB(String transId){
		HashMap<String, String> paymentMap_DB = new HashMap<String, String>();
		try {
			rs = DataBaseUtil.getResultSetPaymentDbChase(SqlQuery
					.getPaymentDetails_Chase_TransID(transId));
			rs.next();
	...
	public static HashMap<String, String> getPaymentProfile_ChaseDB(String custName, String user, String acc)
		...
		HashMap<String, String> paymentMap_DB = new HashMap<String, String>();
		try {
			rs = DataBaseUtil.getResultSetPaymentDbChase(SqlQuery.getCustomerRefNum(custName, user, acc));
			rs.next();
